package com.edaakyil.java.app.generator.random.text.runner;
...
public class TextGeneratorRunner implements ApplicationRunner {
    ...
    public TextGeneratorRunner(Scheduler scheduler, RandomGenerator randomGenerator) // Ctor injection
    {
