...
```curl
curl -d "{\"username\": \"eda\", \"password\": \"csd1993\", \"textCount\": 6, \"textLength\": 4}" -H "Content-Type: application/json" -X POST "http://172.26.16.1:50500/api/generator/password/generate"
```